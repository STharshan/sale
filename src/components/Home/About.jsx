...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Came here on recommendation . Was a little unsure but they were very helpful ( in securing a damaged wing ) even before they got the job . A reasonable price @ an excellent standard . Can’t fault the colour match on a 11 yr old Merc . Kept me informed on progress & finished a day early . I’d use them again !",
    name: "Martyn Pass",
  },
