...
​`,
  ...
  },
  {
    ...
    desc: `
Premium tinting for privacy, UV protection, and cooler interiors.`,
        ...
        <div className="relative overflow-hidden">
          ...
          >
            {services.map((service, index) => (
              <div
                key={index}
                className="relative min-w-[300px] md:min-w-[400px] h-[520px] rounded-lg shadow-lg border-[#dc2626]
